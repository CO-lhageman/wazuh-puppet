...
class wazuh::params_manager {
  case $::kernel {
    ...
    # Installation
      $server_package_version                          = '4.2.5-1'
      ...
      case $::osfamily {
        'Debian': {
          ...
          case $::lsbdistcodename {
            ...
            /^(wheezy|stretch|buster|bullseye|bookworm|sid|precise|trusty|vivid|wily|xenial|bionic|focal)$/: {
              $server_service = 'wazuh-manager'
              $server_package = 'wazuh-manager'
    ...
    'windows': {
      ...
      $agent_package  = 'Wazuh Agent 4.2.5'
      $server_service = ''
      $server_package = ''
      $api_service = ''
      $api_package = ''
